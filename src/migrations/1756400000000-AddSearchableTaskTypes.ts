...
export class AddSearchableTaskTypes1756400000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TYPE "searchable_type_enum" ADD VALUE IF NOT EXISTS 'task'`,
    );
    await queryRunner.query(
      `ALTER TYPE "searchable_type_enum" ADD VALUE IF NOT EXISTS 'form_submission'`,
    );
    await queryRunner.query(
      `ALTER TYPE "searchable_type_enum" ADD VALUE IF NOT EXISTS 'workflow_instance'`,
    );
  }
